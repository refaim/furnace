...
class TestNeedsIdet:
    ...
    def test_tt_fps_just_below_boundary(self) -> None:
...
class TestShouldDeinterlace:
    ...
    def test_tt_low_fps_idet_at_threshold(self) -> None:

...
def _make_movie(tmp_path: Path, sar_num: int = 1, sar_den: int = 1) -> Movie:
    ...
    audio = Track(
        ...
        codec_id=AudioCodecId.AC3, language="eng", title="",
        is_default=True, is_forced=False, source_file=main,
